  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-blue-50 to-blue-100 flex flex-col items-center py-10 px-4">
      <div className="w-full max-w-md bg-blue-50 rounded-3xl shadow-lg p-6 relative">
        <button className="w-full mt-6 py-4 rounded-xl bg-linear-to-r from-blue-500 to-purple-500 text-white font-semibold flex items-center justify-center gap-2 shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition">
          🎙️ Start Recording
        </button>
